...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/pa_consolidated_statute \
  -H 'Content-Type: application/json' \
  -d '{"title":"18","section":"2502"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/pa_consolidated_statute`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
